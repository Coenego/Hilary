 ...
 * A rating model
 *
 * @param  {String}     publicationID       The OAE identifier of the publication
 * @param  {Number}     rating              The rating of a publication
 * @param  {Number}     ratings             The number of rates of a publication
 * @return {Rating}                         Object representing the rating of a publication
 */
var Rating = module.exports.Rating = function(publicationId, rating, ratings) {
    var that = {};
    that.publicationId = publicationId;
    that.rating = rating || 0;
    that.ratings = ratings || 0;
    return that;
};
