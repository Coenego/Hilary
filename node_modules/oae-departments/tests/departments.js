...
describe('Departments', function() {
    ...
    describe('Import departments', function() {
                        ...
                        DepartmentsRestAPI.importDepartments(globalAdminRestContext, null, function(err) {
                            ...
                            DepartmentsRestAPI.importDepartments(globalAdminRestContext, [], function(err) {
                                ...
                                DepartmentsRestAPI.importDepartments(globalAdminRestContext, {}, function(err) {
                                    ...
                                    DepartmentsRestAPI.importDepartments(globalAdminRestContext, {'file': getFileStreamA}, function(err) {
                                        assert.strictEqual(err.code, 400);
                                        return callback();
                                    });
                                });
        ...
        it('verify permissions', function(callback) {
            DepartmentsRestAPI.importDepartments(anonymousGlobalRestContext, {'file': getFileStreamA}, function(err) {
                assert.strictEqual(err.code, 400);

                DepartmentsRestAPI.importDepartments(anonymousCamRestContext, {'file': getFileStreamA}, function(err) {
                    assert.strictEqual(err.code, 401);

                    DepartmentsRestAPI.importDepartments(camUserRestContext, {'file': getFileStreamA}, function(err) {
                        assert.strictEqual(err.code, 401);

                        DepartmentsRestAPI.importDepartments(camAdminRestContext, {'file': getFileStreamA}, function(err) {
                            assert.ok(!err);

                            DepartmentsRestAPI.importDepartments(globalAdminRestContext, {'tenantAlias': global.oaeTests.tenants.cam.alias, 'file': getFileStreamA}, function(err) {
                                assert.ok(!err);
                                return callback();
                            });
                        });
        ...
        it('verify importing departments is successful', function(callback) {
            ...
            TestsUtil.createTenantWithAdmin(tenantAlias, tenantAlias, function(err, tenant, tenantAdminRestContext) {
                ...
                SearchTestsUtil.searchRefreshed(tenantAdminRestContext, 'departments', null, {'q': 'Institute'}, function(err, data) {
                    ...
                    DepartmentsRestAPI.importDepartments(tenantAdminRestContext, {'file': getFileStreamA}, function(err) {
                        assert.ok(!err);
                ...
                SearchTestsUtil.searchRefreshed(tenant1AdminRestContext, 'departments', null, {'q': 'Institute'}, function(err, data) {
                    ...
                    TestsUtil.createTenantWithAdmin(tenantAlias2, tenantAlias2, function(err, tenant2, tenant2AdminRestContext) {
                        ...
                        SearchTestsUtil.searchRefreshed(tenant2AdminRestContext, 'departments', null, {'q': 'Division'}, function(err, data) {
                            ...
                            DepartmentsRestAPI.importDepartments(tenant1AdminRestContext, {'file': getFileStreamA}, function(err) {
                                assert.ok(!err);

                                // Import a CSV file for the second created tenant
                                DepartmentsRestAPI.importDepartments(tenant2AdminRestContext, {'file': getFileStreamB}, function(err) {
                                    assert.ok(!err);
